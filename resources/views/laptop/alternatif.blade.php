                                ...
                                <?php 
                                        ...
                                        $totalminVektor=array_sum($minVektor);
                                            ...
                                            foreach($minVektor as $key => $a){
                                                $normalisasiBobot[$keyone][$key]=$a/$totalminVektor;
                                            }
                                    ?>
                                <td>Total</td>
                ...
                <table class="table table-bordered ">
                    ...
                    <tbody>
                            <tr>
                                    ...
                                    <td>V (S1 ≥ S2,S3,S4,S5,S6,S7,S8)</td>
                                    <td>{{ $normalisasiBobot[$keyone][0]}} </td>
                                </tr>
                                <tr>
    
                                    <td>V (S2 ≥ S1,S3,S4,S5,S6,S7,S8)</td>
                                    <td>{{ $normalisasiBobot[$keyone][1]}} </td>
                                </tr>
                                <tr>
    
                                    <td>V (S3 ≥ S1,S2,S4,S5,S6,S7,S8)</td>
                                    <td>{{ $normalisasiBobot[$keyone][2]}} </td>
                                </tr>
                                <tr>
    
                                    <td>V (S4 ≥ S1,S2,S3,S5,S6,S7,S8)</td>
                                    <td>{{ $normalisasiBobot[$keyone][3]}} </td>
                                </tr>
                                <tr>
    
                                    <td>V (S5 ≥ S1,S2,S3,S4,S6,S7,S8)</td>
                                    <td>{{ $normalisasiBobot[$keyone][4]}} </td>
                                </tr>
                                <tr>
    
                                    <td>V (S6 ≥ S1,S2,S3,S4,S5,S7,S8)</td>
                                    <td>{{ $normalisasiBobot[$keyone][5]}} </td>
                                </tr>
                                 <tr>
    
                                    <td>V (S7 ≥ S1,S2,S3,S4,S5,S6,S8)</td>
                                    <td>{{ $normalisasiBobot[$keyone][6]}} </td>
                                </tr>
                                 <tr>
    
                                    <td>V (S8 ≥ S1,S2,S3,S4,S5,S6,S7)</td>
                                    <td>{{ $normalisasiBobot[$keyone][7]}} </td>
                                </tr>
                        
                        <tr>
                            <?php 
                                      
                                        $maxBobot =max($normalisasiBobot[$keyone]);
