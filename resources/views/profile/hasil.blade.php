        ...
        {{-- <div class="d-none"> --}}
                <div class="d-none">
                    ...
                    <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                <h4 class="header-title mb-3"> Hai {{$nama}}, dengan perkerjaan anda {{$pekerjaan}}</h4>
                                                             
                                    <div class="alert alert-primary" role="alert">
                                        
                                            
                                            <h3> Profile anda termasuk {{ $rankProfile[0]['tipe'] }} disarankan untuk smartphone {{$hasilRekomendasi[0]['nama'] }},{{$hasilRekomendasi[1]['nama'] }},{{$hasilRekomendasi[2]['nama'] }}</h3>
                                            <h4><justify>Berdasarkan Hasil Pengisian Kuisioner, Didapatkanlah Kesimpulan smartphone yang cocok untuk anda adalah {{$hasilRekomendasi[0]['nama'] }},{{$hasilRekomendasi[1]['nama'] }},{{$hasilRekomendasi[2]['nama'] }}. 
	                                            karena profile anda adalah {{ $rankProfile[0]['tipe'] }} dan pada {{ $rankProfile[0]['tipe'] }}, 
                                                @if($rankProfile[0]['tipe']=="travel") kamera 
                                                @elseif($rankProfile[0]['tipe']=="game") procesor 
                                                @elseif($rankProfile[0]['tipe']=="video") kamera 
                                                @elseif($rankProfile[0]['tipe']=="fotografi") kamera 
                                                @elseif($rankProfile[0]['tipe']=="rapat") ram 
                                                @elseif($rankProfile[0]['tipe']=="fitur") rom
                                                @elseif($rankProfile[0]['tipe']=="email") rom 
                                                @elseif($rankProfile[0]['tipe']=="reading") layar
                                                @elseif($rankProfile[0]['tipe']=="sosmed") layar  
                                                @elseif($rankProfile[0]['tipe']=="akun") rom  
                                                @elseif($rankProfile[0]['tipe']=="shopping") rom  
                                                @elseif($rankProfile[0]['tipe']=="koneksi") Processor   @endif merupakan komponen utama yang dilihat.{{$hasilRekomendasi[0]['nama'] }},{{$hasilRekomendasi[1]['nama'] }},{{$hasilRekomendasi[2]['nama'] }} merupakan smartphone dengan 
	                                            @if($rankProfile[0]['tipe']=="travel") kamera 
                                                @elseif($rankProfile[0]['tipe']=="game") procesor 
                                                @elseif($rankProfile[0]['tipe']=="video") kamera 
                                                @elseif($rankProfile[0]['tipe']=="fotografi") kamera 
                                                ...
                                                @elseif($rankProfile[0]['tipe']=="akun") rom  
                                                @elseif($rankProfile[0]['tipe']=="shopping") rom  
                                                @elseif($rankProfile[0]['tipe']=="koneksi") Processor   @endif terbaik diantara alternatif smartphone lainnya. Untuk melihat spesifikasi smartphone, silahkan klik informasi spesifikasi smartphone dibawah ini </justify></h4>


                                                <a href = "/spesifikasi">
                                                <i class="mdi mdi-database"></i> <span> Informasi spesifikasi SmartPhone </span>
                                                </a>
